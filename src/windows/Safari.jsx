...
import TaskDetailView from "#components/Safari/TaskDetailView";
import TaskTabs from "#components/Safari/TaskTabs";
import TaskCard from "#components/Safari/TaskCard";
import EmptyState from "#components/Safari/EmptyState";
...
const tasksByStatus = {
  ...
  in_progress: tasks.filter(t => 
    t.status === 'in_progress' && t.reviewStatus !== 'rejected' // ⭐ EXCLUIR RECHAZADAS
  ),
