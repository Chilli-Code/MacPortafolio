...
<div className="flex items-center gap-2">
  ...
  {task.status === 'in_progress' && !isRejected && (
    <button onClick={onComplete} className="px-4 py-2 bg-green-500 hover:bg-green-600 text-white text-sm font-medium rounded-lg transition-colors flex items-center gap-2">
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-4xl mx-auto p-6 space-y-6">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
            ...
            <div className="flex flex-wrap gap-2">
              {task.tags?.map((tag, index) => (
                <span
                  key={index}
                  className="px-4 py-2 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg hover:border-blue-500 dark:hover:border-blue-400 transition-colors"
                >
                  {tag}
                </span>
              ))}
          ...
          {/* Timeline or Notes */}
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6">
            <div className="flex items-center gap-2 mb-4">
        ...
        <div className="flex items-center justify-between max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-3">
            {task.status === 'available' && (
              <button
                onClick={onAccept}
                className="px-6 py-2.5 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors font-semibold flex items-center gap-2 shadow-lg shadow-blue-500/30"
              >
            ...
            {task.status === 'in_progress' && (
              <button
                onClick={onComplete}
                className="px-6 py-2.5 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-colors font-semibold flex items-center gap-2 shadow-lg shadow-green-500/30"
              >
            ...
            {task.status === 'rejected' && (
              <button
                onClick={onReopen}
                className="px-6 py-2.5 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white rounded-lg transition-colors font-semibold flex items-center gap-2 shadow-lg"
              >
                <RefreshCw className="w-5 h-5" />
                Corregir y Volver a Intentar
              </button>
