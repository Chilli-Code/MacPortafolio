...
import { Clipboard, Clock, XCircle, CheckCircle, Eye } from '#assets/icons';
    ...
    <div className="flex gap-2 justify-evenly">
      {tabs.map(tab => (
        ...
        >
          ...
          {tab.icon}
          <span className='overflow-hidden text-ellipsis whitespace-nowrap max-w-[100px]'>{tab.label}</span>
